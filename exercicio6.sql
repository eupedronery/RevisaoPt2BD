...
--1) Consultar, da tabela viagem, todas as horas de chegada e saída, 
...
--3) Consultar, com subquery, a descrição do ônibus que vai para o Rio de Janeiro
SELECT descricao
FROM onibus
WHERE placa IN (
               SELECT onibus_placa
...
--4) Consultar, com Subquery, a descrição, a marca e o ano do ônibus 
