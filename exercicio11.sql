...
VALUES              ('85987458920', 'Maria Paula', 'R. Voluntários da Pátria', 589, 'Santana', 98458741, 2345),
...
VALUES             (1, 'Claudio', 'Clínico Geral', 1234),
...
SELECT p.nome,
       p.rua + ', ' + CAST(p.numero AS VARCHAR(5)) + ', ' + p.bairro AS endereço,
	   p.telefone,
	   pds.nome
...
--Consultar Data da consulta, Hora da consulta, nome do médico,
--nome do paciente e diagnóstico de todas as consultas
SELECT DISTINCT 
...
--Consultar Nome do médico, data e hora de consulta 
--e diagnóstico de José Lima
SELECT m.nome,
