...
INSERT INTO medicamento (nome, apresentacao, unidade_cadastro, preço_proposto)
...
--(como nome de remédio), apresentação do remédio, unidade, preço proposto, 
--quantidade vendida e valor total dos remédios vendidos a Maria Zélia
SELECT DISTINCT
       c.CPF,
       c.rua + ', ' + c.bairro + ', ' + CAST(c.N AS VARCHAR(5)) AS endereço,
	   m.nome,
	   m.apresentacao,
	   m.unidade_cadastro,
	   m.preço_proposto,
